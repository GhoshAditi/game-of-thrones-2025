    ...
    return (
      ...
      >
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <span
                      ...
                      onClick={() => item.paymentstatus === "Not Verified" && setIsDialogOpen(true)}
                    >
                      {item.paymentstatus}
                    </span>
                  </TooltipTrigger>
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogContent>
            <DialogHeader>
              <h1 className="text-2xl font-bold text-gray-900">Transaction Screenshot</h1>
            </DialogHeader>
            <Image
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <Button
          ...
          variant="outline"
          disabled={
            !searchQuery && !paymentStatusFilter && !eventFilter && !typeFilter && !collegeFilter && !registeredAtFilter
          }
