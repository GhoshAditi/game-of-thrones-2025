...
import { type RegisterTeamParams, registerTeamWithParticipants } from "@/utils/functions/events/registerTeam"
  ...
  return (
    ...
    >
      <DialogContent className="sm:max-w-[500px] bg-black border border-[#8B5CF6] rounded-xl p-6">
        <DialogHeader>
          <DialogTitle className="text-white text-2xl">Registration for {eventName}</DialogTitle>
        </DialogHeader>
        <p className="text-gray-400 mt-2">
          Team Members: {totalTeamCount} (Min: {minTeamSize}, Max: {maxTeamSize})
        </p>
        {teamMembers.length > 0 && (
          <span className="text-[#8B5CF6] cursor-pointer hover:underline" onClick={() => setIsSheetOpen(true)}>
        ...
        {step === 1 && (
          <form onSubmit={handleTeamLeadSubmit(onTeamLeadSubmit)} className="overflow-y-auto my-scrollbar max-h-[65vh]">
            <div className="grid gap-6 py-4">
              ...
              <div className="grid gap-2">
                ...
                />
                {teamLeadErrors.teamName && <p className="text-red-500 text-sm">{teamLeadErrors.teamName.message}</p>}
              </div>
              <div className="grid gap-2">
                ...
                />
                {teamLeadErrors.name && <p className="text-red-500 text-sm">{teamLeadErrors.name.message}</p>}
              </div>
              <div className="grid gap-2">
                ...
                />
                {teamLeadErrors.phone && <p className="text-red-500 text-sm">{teamLeadErrors.phone.message}</p>}
              </div>
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  readOnly
                />
                {teamLeadErrors.email && <p className="text-red-500 text-sm">{teamLeadErrors.email.message}</p>}
              </div>
              <div className="grid gap-2">
            ...
            <div className="flex justify-end gap-4">
              ...
              <Button type="submit" className="bg-[#8B5CF6] text-white hover:bg-[#8B5CF6]/90 border-0">
                Next
              </Button>
            </div>
          </form>
            ...
            {isAddingMember ? (
              ...
              >
                <div className="grid gap-2">
                  ...
                  />
                  {teamMemberErrors.name && <p className="text-red-500 text-sm">{teamMemberErrors.name.message}</p>}
                </div>
                <div className="grid gap-2">
                  ...
                  />
                  {teamMemberErrors.phone && <p className="text-red-500 text-sm">{teamMemberErrors.phone.message}</p>}
                </div>
                <div className="grid gap-2">
                  ...
                  />
                  {teamMemberErrors.email && <p className="text-red-500 text-sm">{teamMemberErrors.email.message}</p>}
                </div>
        ...
        {step === 3 && (
          <form onSubmit={handlePaymentSubmit(onPaymentSubmit)} className="overflow-y-auto max-h-[65vh]">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-4">
              ...
              <Button type="submit" className="bg-[#8B5CF6] text-white hover:bg-[#8B5CF6]/90 border-0" disabled={isRegistering}>
